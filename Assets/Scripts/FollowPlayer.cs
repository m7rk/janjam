...
public class FollowPlayer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.position = Vector3.SmoothDamp(transform.position, new Vector3(targetX, targetY, this.transform.position.z) + lookaheadVector, ref refvector, timeToOfset);
    }
}
